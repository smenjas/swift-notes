...
## Books
- [The Swift Programming Language](https://docs.swift.org/swift-book/)
- [No Starch Press](https://nostarch.com/search/node/swift)
  - [Coding iPhone Apps for Kids](https://nostarch.com/iphoneappsforkids)
- [O'Reilly](https://www.oreilly.com/search/?query=swift)

## [Machine Learning](https://en.wikipedia.org/wiki/Machine_learning)
- [Swift for TensorFlow](https://www.tensorflow.org/swift)
  - [GitHub: Swift for TensorFlow Deep Learning Library](https://github.com/tensorflow/swift-apis)
  - [Models and examples built with Swift for TensorFlow](https://github.com/tensorflow/swift-models)
